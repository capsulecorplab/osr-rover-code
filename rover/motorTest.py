...
class MotorTestMethods(unittest.TestCase):
    ...
    def test_Logic_battery0(self):
        self.assertTrue(
            4.5 <= (rc.ReadLogicBatteryVoltage(address[0])[1])/10.0 <= 5.5)

    def test_Logic_battery1(self):
        self.assertTrue(
            4.5 <= (rc.ReadLogicBatteryVoltage(address[1])[1])/10.0 <= 5.5)

    def test_Logic_battery2(self):
        self.assertTrue(
            4.5 <= (rc.ReadLogicBatteryVoltage(address[2])[1])/10.0 <= 5.5)

    def test_Logic_battery3(self):
        self.assertTrue(
            4.5 <= (rc.ReadLogicBatteryVoltage(address[3])[1])/10.0 <= 5.5)

    def test_Logic_battery4(self):
        self.assertTrue(
            4.5 <= (rc.ReadLogicBatteryVoltage(address[4])[1])/10.0 <= 5.5)

    def test_Main_battery0(self):
        self.assertTrue(
            11.5 <= (rc.ReadMainBatteryVoltage(address[0])[1])/10.0 <= 12.5)

    def test_Main_battery1(self):
        self.assertTrue(
            11.5 <= (rc.ReadMainBatteryVoltage(address[1])[1])/10.0 <= 12.5)

    def test_Main_battery2(self):
        self.assertTrue(
            11.5 <= (rc.ReadMainBatteryVoltage(address[2])[1])/10.0 <= 12.5)

    def test_Main_battery3(self):
        self.assertTrue(
            11.5 <= (rc.ReadMainBatteryVoltage(address[3])[1])/10.0 <= 12.5)

    def test_Main_battery4(self):
        self.assertTrue(
            11.5 <= (rc.ReadMainBatteryVoltage(address[4])[1])/10.0 <= 12.5)
    ...
    def test_motor4_F(self):
        self.assertTrue(test_motor(
            4, 1) > 0, msg="Encoder Value error, should have read ABOVE 0, \
            instead was :" + str(getEnc(4)))

    def test_motor4_B(self):
        self.assertTrue(test_motor(
            4, -1) < 0, msg="Encoder Value error, should have read BELOW 0, \
            instead was : " + str(getEnc(4)))

    def test_motor5_F(self):
        self.assertTrue(test_motor(
            5, 1) > 0, msg="Encoder Value error, should have read ABOVE 0, \
            instead was : " + str(getEnc(5)))

    def test_motor5_B(self):
        self.assertTrue(test_motor(
            5, -1) < 0, msg="Encoder Value error, should have read BELOW 0, \
            instead was : " + str(getEnc(5)))

    def test_motor6_F(self):
        self.assertTrue(test_motor(
            6, 1) > 0, msg="Encoder Value error, should have read ABOVE 0, \
            instead was : " + str(getEnc(6)))

    def test_motor6_B(self):
        self.assertTrue(test_motor(
            6, -1) < 0, msg="Encoder Value error, should have read BELOW 0, \
            instead was : " + str(getEnc(6)))

    def test_motor7_F(self):
        self.assertTrue(test_motor(
            7, 1) > 0, msg="Encoder Value error, should have read ABOVE 0, \
            instead was : " + str(getEnc(7)))

    def test_motor7_B(self):
        self.assertTrue(test_motor(
            7, -1) < 0, msg="Encoder Value error, should have read BELOW 0, \
            instead was : " + str(getEnc(7)))

    def test_motor8_F(self):
        self.assertTrue(test_motor(
            8, 1) > 0, msg="Encoder Value error, should have read ABOVE 0, \
            instead was : " + str(getEnc(8)))

    def test_motor8_B(self):
        self.assertTrue(test_motor(
            8, -1) < 0, msg="Encoder Value error, should have read BELOW 0, \
            instead was : " + str(getEnc(8)))

    def test_motor9_F(self):
        self.assertTrue(test_motor(
            9, 1) > 0, msg="Encoder Value error, should have read ABOVE 0, \
            instead was : " + str(getEnc(9)))

    def test_motor9_B(self):
        self.assertTrue(test_motor(
            9, -1) < 0, msg="Encoder Value error, should have read BELOW 0, \
            instead was : " + str(getEnc(9)))
